    ...
    _createClass(MultiSelect, [{
        ...
        value: function findSelectionIndex(value) {
            ...
            if (this.props.value) {
                for (var i = 0; i < this.props.value.length; i++) {
                    if (_ObjectUtils2.default.equals(this.props.value[i], value, this.props.key)) {
                        index = i;
                        break;
                    }
                }
        ...
        value: function filterOptions(options) {
            ...
            return options.filter(function (option) {
                return _this2.filterOption(option);
            });
        }
    }, {
        key: 'getOptionValue',
        ...
        value: function render() {
            ...
            if (items) {
                ...
                items = items.map(function (option, index) {
                    ...
                    return _react2.default.createElement(_MultiSelectItem.MultiSelectItem, { key: optionLabel + '_' + index, label: optionLabel, option: option, template: _this3.props.itemTemplate,
