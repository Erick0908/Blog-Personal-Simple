...
var Spinner = exports.Spinner = function (_Component) {
    ...
    _createClass(Spinner, [{
        ...
        value: function onInputKeyUp(event) {
            ...
            if (event.key === this.props.decimalSeparator || event.key === this.props === this.props.thousandSeparator) this.value = inputValue;else this.value = this.parseValue(inputValue);
